...
>>>>>>> 0ba96153362ad3ce74562c999241ceda24b40bcc
        ...
        <div className={styles.session}>
          ...
          <div className={styles.sessionDetails}>
            {sessions.map((session, index) => (
              <div className={styles.sessionCard2} key={index}>
                <p style={{ marginBottom: 20, width: 120 }}>{session.time}</p>
                <div className={styles.sessionCard} style={{ backgroundColor: session.backgroundColor }}>
...
<div className={styles.clientslist}>
        ...
        Type of Payment
=======
          <div className={styles.clientslist}>Clients</div>
          {newClients.map((client, index) => (
            <div key={index} className={styles.newclientItem}>
...
>>>>>>> 0ba96153362ad3ce74562c999241ceda24b40bcc
        ...
        <div className={styles.clientslist}>Comment</div>
        <div>Aliquam pulvinar vestibulum blandit. Donec sed nisl libero.</div>
        <div className={styles.clientslist}>Type of Payment</div>
        <div className={styles.cashIcon_txt}>
          <CashIcon />
          <div style={{ marginLeft: 10 }}>Cash</div>
        </div>
        <OpticityButton
