...
const EditClient = ({ setSelectedItem }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      trainingGoal: Yup.string()
        .required('Training goal is required'),
      rate: Yup.string()
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (moment(values.DOB, expectedFormat, true).isValid())
        ...
        <div className={styles.main_div__}>
          <div className={styles.left_div_profile}>
            <Image
              ...
              src={selectedFile || getData?.clientDetails?.clientImage || profileiconn}
