...
const TextWithButton = ({ label, text, buttonText, RightIcon, LeftIcon,props,RightBox,space,onClick,style }) => {
    return (
        <div style={style} className={`${styles.container} ${props?.additionalcontainer || ''}`}>
